...
const PROJECTS = [
  {
    ...
    desc: "A production WMS for 3PL providers featuring multi-tenant data isolation, real-time inventory across warehouses and bins, multi-channel order sync (Shopify, Amazon, Walmart, TikTok Shop), and intelligent AI modules including an AI chat assistant and automated AI summaries of warehouse operations, orders, and shipments.",
    stack: ["NestJS", "Node.js", "React", "PostgreSQL", "Prisma", "AI / LLM", "TypeScript", "Tailwind"],
    live: "http://3plsmart.com/",
    featured: true,
  },
  {
    n: "02",
